...
urlpatterns = [
    ...
    path('generateitem/', views.generateitem, name='generateitem'),
    path('processitems/', views.processitems, name='processitems'),
    path('itemtypes/', views.itemtypes, name='itemtypes'),
