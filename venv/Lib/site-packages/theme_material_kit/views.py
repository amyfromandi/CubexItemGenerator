...
def generateitem(request):
  return render(request, 'pages/generateitem.html')


def itemtypes(request):
  return render(request, 'pages/itemtypes.html')

def processitems(request):
  return render(request, 'pages/processitems.html')
